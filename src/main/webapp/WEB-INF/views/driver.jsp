        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="form-horizontal well col-xs-12" name="addForm">
                    ...
                    <div class="form-group col-xs-6">
                        <input type="text" placeholder="Surname" ng-model="driver.surname" name="surname" minlength="2"
                    ...
                    <div class="form-group col-xs-6">
                        <input type="text" class="form-control" minlength="1" maxlength="2" name="driversLicenseClass"
