...
<html ng-app="controllers" ng-controller="UserController" layout="column">
<body layout="column">
...
<md-content layout-padding layout-margin layout="column" layout-align="center center" flex>
    <form method="POST" name="login" action="<c:url value="/login"/>" layout-align="center center" layout="column">
        ...
        <div>
            ...
            <md-button type="submit" class="md-primary md-raised" id="login">Login</md-button>
            <md-button class="md-primary" id="signUp" data-target="#add" data-toggle="modal"
                       onclick="event.preventDefault()">
                <md-icon>signup</md-icon>
                Sign Up
            </md-button>
        </div>
    </form>
