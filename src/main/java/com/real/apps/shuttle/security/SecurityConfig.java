...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/vehicle-add").hasAnyRole(ROLE_ADMIN, ROLE_COMPANY_USER)
                .antMatchers("/trip-add").hasAnyRole(ROLE_ADMIN, ROLE_AGENT, ROLE_COMPANY_USER, ROLE_WORLD)
                .antMatchers("/review").hasAnyRole(ROLE_ADMIN, ROLE_AGENT, ROLE_COMPANY_USER, ROLE_WORLD)
                .antMatchers("/review-add").hasAnyRole(ROLE_ADMIN, ROLE_AGENT, ROLE_COMPANY_USER, ROLE_WORLD)
                .antMatchers("/agent-add").hasAnyRole(ROLE_ADMIN)
                .antMatchers("/company-add").hasAnyRole(ROLE_ADMIN, ROLE_AGENT)
                .antMatchers("/driver-add").hasAnyRole(ROLE_ADMIN, ROLE_COMPANY_USER)
